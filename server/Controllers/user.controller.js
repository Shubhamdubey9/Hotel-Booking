...
//       console.log(
//         `❌ Role mismatch: sent role = "${role}", user.role = "${user.role}"`
//       );
//       return res.status(400).json({
...
//     const userId = req.userId; // Auth middleware should set this
...
//     if (user) {
//       return res.status(400).json({
//         message: "User alreday exist this email",
//         success: false,
//       });
//     }
//     const hashedPassword = await bcrypt.hash(password, 10);
...
//     });
//     return res.status(201).json({
//       message: "Account is created successfull",
//       success: true,
//     });
//   } catch (error) {
//     console.log(error);
...
//     // chek role is correct or not corect
//     if (role !== user.role) {
//       return res.status(400).json({
//         message: "Account does not exist current role",
//         success: false,
//       });
//     }
